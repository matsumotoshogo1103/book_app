...
アカウント登録をしたユーザーです。<br>
ユーザーの年齢や職種、性別が記載されており気になった人の本棚を覗きに行きます。</h4>
...
<h4>はじめはあれもこれも便利な機能を追加したくなりますが、最低限必要な機能をシンプルに実装することを心がけました。<br>
...
<h4>ユーザーに関しての情報をより詳細に入力してもらうことで使いやすさが向上すると考えられますが、<br>
...
アフィリエイト収入が入る仕組みがあると上記の様な層も取り込んでいけるのではと考えております。</h4>
